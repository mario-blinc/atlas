module.exports = async function handler(req, res) {
  ...
  const mock = {
    ...
    tasks: [
      { id: '1', content: 'Client amends',                    due_date: new Date(now.getTime()-18*86400000).toISOString(), priority: 2 },
      { id: '2', content: 'New business proposal',            due_date: new Date(now.getTime()-15*86400000).toISOString(), priority: 2 },
      ...
      { id: '7', content: "Long Story Short — review chapter draft", due_date: now.toISOString(), priority: 2 },
      { id: '8', content: 'Follow up with supplier',          due_date: now.toISOString(), priority: 1 },
    ],
    threads: [
      ...
      { id: 't3', messages: [{ id:'m3', date: new Date(now.getTime()-24*3600000).toISOString(), sender:'Shopify',       subject:'3 new orders to fulfil',          snippet:'You have 3 new orders waiting to be fulfilled.',                                        labelIds:['UNREAD','INBOX'] }] },
