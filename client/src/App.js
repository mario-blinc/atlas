...
const DUMMY = (() => {
  ...
  return {
    ...
    events: [
      ...
      { id:'2', title:'Client Brand Review',     start:t(11,0),  end:t(12,0),   location:'Studio'      },
      { id:'3', title:'Lunch with Pascal',       start:t(13,0),  end:t(14,0),   location:'Shoreditch'  },
      { id:'4', title:'Studio Manager Check-in', start:t(15,30), end:t(16,30),  location:'Zoom'        },
    ],
    upcoming: [
      { id:'5', title:'New Client Kickoff',    start: new Date(now.getTime()+4*86400000).toISOString() },
      { id:'6', title:'Client Photoshoot',     start: new Date(now.getTime()+6*86400000).toISOString() },
    ],
    tasks: [
      { id:'1', content:'Client amends',                   due_date:new Date(now.getTime()-18*86400000).toISOString() },
      { id:'2', content:'New business proposal',           due_date:new Date(now.getTime()-15*86400000).toISOString() },
      ...
      { id:'7', content:"Long Story Short — review chapter", due_date:now.toISOString() },
      { id:'8', content:'Follow up with supplier',         due_date:now.toISOString() },
    ],
    threads: [
      ...
      { id:'t3', messages:[{ sender:'Shopify',       subject:'3 new orders to fulfil',            date:new Date(now.getTime()-24*3600000).toISOString() }] },
